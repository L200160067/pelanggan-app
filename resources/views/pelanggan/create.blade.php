...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active"><i class="bi bi-plus-circle"></i> Tambah Pelanggan</li>
        </ol>
    </nav>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white border-bottom py-3">
            <h5 class="mb-0 fw-bold text-primary">
                <i class="bi bi-person-plus"></i> Form Tambah Pelanggan Baru
            </h5>
        </div>
        <div class="card-body">
            <form action="{{ route('pelanggan.store') }}" method="POST" id="formPelanggan">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                        id="nama" placeholder="Contoh: Budi Santoso" value="{{ old('nama') }}" minlength="3"
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control @error('usia') is-invalid @enderror" name="usia"
                            id="usia" placeholder="Contoh: 25" value="{{ old('usia') }}" min="1"
                            max="150" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat"
                        placeholder="Masukkan alamat lengkap Anda..." rows="4" minlength="5" maxlength="1000" required>{{ old('alamat') }}</textarea>
                    <small class="form-text text-muted d-block mt-2 d-flex justify-content-between">
                        ...
                        <span><strong id="charCount">0</strong>/1000 karakter</span>
                    </small>
                    @error('alamat')
                        <div class="invalid-feedback d-block mt-2">
                            <i class="bi bi-exclamation-circle"></i> {{ $message }}
